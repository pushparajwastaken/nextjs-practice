...
export default function Globe3DDemoThird() {
  return (
    <div className="min-h-screen bg-black text-black font-mono py-12 pt-36">
      <div className="relative mx-auto h-100 w-full max-w-7xl overflow-hidden rounded-xl bg-white shadow-sm ring-1 shadow-black/10 ring-black/10 dark:bg-neutral-950 min-h-auto font-mono">
        <div className="relative z-10 p-4 md:p-12">
          <h2 className="mb-4 max-w-2xl text-2xl font-extrabold tracking-tight text-balance text-neutral-900 md:text-5xl lg:text-6xl dark:text-white">
            Connect to us from all over the globe
          </h2>
          <p className="mt-2 max-w-lg text-balance text-neutral-600 md:mt-8 md:text-lg dark:text-neutral-400">
            Share your contanct details and our team will shortly be in touch
            with you.
          </p>
